...
By making a Contribution to this repository, I agree to the terms of the following documents located at [https://github.com/git-bom/spec](https://github.com/git-bom/spec):

(a) Community Specification License 1.0 (LICENSE.md)

(b) Community Specification Contribution Policy 1.0 (CONTRIBUTING.md)

(c) Community Specification Code of Conduct (code-of-conduct.md)
